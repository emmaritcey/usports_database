...
def run():
    ...
    df.loc[ df['NAME'] == 'Harleen Sidhu', 'NAME'] = 'Harleen Sidhu Dulay'
    df.loc[ df['NAME'] == 'Jessie Brown', 'NAME'] = 'Jessica Brown'
    ...
    df.loc[ df['NAME'] == 'Alex Kiss-Rusk', 'NAME'] = 'Alexandria Kiss-Rusk'
